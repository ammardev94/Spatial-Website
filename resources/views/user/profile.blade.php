...
<div class="row">
    <div class="col-md-2 border-0">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('user.profile.update') }}" method="POST" id="imgForm" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="text-center">
                        @if (!empty($user->img))                            
                            <span class="profile-pic">
                                <img id="profile-img" src="{{ asset('storage/'.$user->img) }}" alt="{{ $user->name }}">
                            </span>
                        @endif
                    ...
                    <div class="profile-uploader profile-uploader-two mb-0">
                        ...
                        @if (!empty($user->img)) 
                            <input type="hidden" id="existingImg" value="{{ $user->img }}" />
                        @endif
    ...
    <div class="col-md-10 border-0">
        ...
        <div class="card">
            <form action="{{ route('user.profile.update') }}" method="POST" id="personalInfoForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
